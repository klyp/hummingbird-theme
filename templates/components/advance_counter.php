<?php
    ...
    // Settings
    $title                = get_sub_field('component_advance_counter_title');
    $subTitle             = get_sub_field('component_advance_counter_subtitle');
    $percentage           = get_sub_field('component_advance_counter_percentage');
?>
