<?php
    // General.
    $componentId     = get_field('component_image_column_id') ?: 'random_' . rand();
    $componentClass  = get_field('component_image_column_class');
    $enableComponent = get_field('component_image_column_enable');
    $globalComponent = get_field('component_image_column_global_component');
